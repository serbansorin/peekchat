<template>
    <div as="template" v-if="open" id="ContactSlide">
        ...
        <div class="fixed">
          <div class="absolute">
            <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
              <div as="template" enter="transform transition ease-in-out duration-500 sm:duration-700" enter-from="translate-x-full" enter-to="translate-x-0" leave="transform transition ease-in-out duration-500 sm:duration-700" leave-from="translate-x-0" leave-to="translate-x-full">
                <div class="pointer-events-auto w-screen max-w-md">
                  <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                    <div class="p-6">
                                        <div class="flex items-start justify-between">
                        <div class="text-base font-semibold leading-6 text-gray-900">Team</div>
                                    ...
                                    <ul role="list" class="flex-1 divide-y divide-gray-200 overflow-y-auto">
                                        <li v-for="person in team" :key="person.handle">
                                            <div class="group relative flex items-center px-5 py-6">
                                                <a :href="person.href" @click="emit('selectFriend', { name: person.name, id: person.id})" class="-m-1 block flex-1 p-1">
                            <div class="absolute  group-hover:bg-gray-50" aria-hidden="true" />
...
const emit = defineEmits(['selectFriend', 'close']);
